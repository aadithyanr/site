      ...
      <div className="flex items-center justify-between">
        ...
        <div className="ml-3 flex flex-grow flex-col justify-between">
          <span className="text-[15px] font-medium md:text-lg">
            {item.company}
            {item.present && (
              <span className="ml-1 rounded-lg bg-neutral-200 px-2 pb-1 pt-1.5 text-sm font-normal text-neutral-700 dark:bg-neutral-800 dark:text-neutral-300">
                Present
              </span>
            )}
            {item.incoming && (
              <span className="ml-2 rounded-full bg-neutral-200 px-2.5 py-0.5 text-xs font-medium text-neutral-800 dark:bg-neutral-800 dark:text-neutral-200">
                Incoming
              </span>
            )}
          </span>
